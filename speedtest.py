...
def write_csvfile(
    ...
    if filetype == "LOG":
        ...
        fileformat = "{},{},{},{},{}\r\n".format(
            date, timestamp_log, field_1, field_2, field_3
        )
        ...
        fileformat = "{},{},{},{},{},{},{},{}\r\n".format(
            date, timestamp, field_1, field_2, field_3, field_4, field_5, field_6
        )
        ...
        fileformat = "{},{},{},{},{},{},{}\r\n".format(
            date, timestamp, field_1, field_2, field_3, field_4, field_5
        )
...
try:
    ...
    returncode = write_csvfile(
        filetype_log, logtype, logdescription, logoutput, "", "", "", "", "", "", ""
    )
...
if iperf and target_ip != None:
    try:
        ...
        iperf_output = (
            subprocess.Popen(
                f"/usr/bin/iperf3 -c {target_ip}", shell=True, stdout=subprocess.PIPE
            )
            .stdout.read()
            .decode("utf-8")
        )
...
if returncode[0] == 1:
    write_csvfile(
        filetype_tmplog, logtype, logdescription, logoutput, "", "", "", "", "", "", ""
    )
...
try:
    if target_id != None:
        ...
        speedtest_output = (
            subprocess.Popen(
                f"/usr/bin/speedtest --accept-license --accept-gdpr --server-id={target_id}",
                shell=True,
...
returncode = write_csvfile(
    filetype_speedtest, server, ping, jitter, download, upload, "", "", "", "", ""
)
